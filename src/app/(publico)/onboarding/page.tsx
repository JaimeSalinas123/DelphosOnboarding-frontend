...
const STUDY_METHODS = [
  {
    ...
    renderVisual: () => (
      <div className="flex flex-col gap-3.5 w-full font-sans">
        <div className="self-end bg-white border border-gray-200 rounded-2xl rounded-tr-sm px-4 py-3 sm:py-3.5 text-sm shadow-sm max-w-[90%] sm:max-w-[80%]">
          <div className="text-[10px] text-gray-400 font-mono uppercase tracking-widest mb-1.5">Tú</div>
          <p className="text-slate-700 leading-relaxed">¿Qué módulo cubre la facturación electrónica?</p>
        </div>
        <div className="self-start bg-brand-orange/10 border border-brand-orange/20 rounded-2xl rounded-tl-sm px-4 py-3 sm:py-3.5 text-sm shadow-sm max-w-[90%] sm:max-w-[80%]">
          <div className="text-[10px] text-brand-orange font-mono uppercase tracking-widest mb-1.5">Asistente Delphos</div>
          <p className="text-slate-800 leading-relaxed">El módulo de Finanzas. ¿Quieres ver un cliente real que lo use?</p>
        </div>
        <div className="self-end bg-white border border-gray-200 rounded-2xl rounded-tr-sm px-4 py-3 sm:py-3.5 text-sm shadow-sm max-w-[90%] sm:max-w-[80%]">
          <div className="text-[10px] text-gray-400 font-mono uppercase tracking-widest mb-1.5">Tú</div>
          <p className="text-slate-700 leading-relaxed">Sí, muéstrame uno del sector retail.</p>
        </div>
      </div>
    )
  },
    ...
    renderVisual: () => (
      <div className="flex flex-col gap-3 w-full font-sans">
        <div className="flex items-center gap-3 p-3.5 sm:p-4 rounded-xl border-2 border-brand-orange bg-brand-orange/5 shadow-sm transition-all">
          ...
          <span className="text-[13px] sm:text-sm font-semibold text-brand-orange leading-tight">Gestión integral de procesos corporativos</span>
        </div>
        <div className="flex items-center gap-3 p-3.5 sm:p-4 rounded-xl border border-gray-200 bg-white shadow-sm transition-all opacity-70">
          ...
          <span className="text-[13px] sm:text-sm font-medium text-gray-600 leading-tight">Solo control de inventario</span>
        </div>
        <div className="flex items-center gap-3 p-3.5 sm:p-4 rounded-xl border border-gray-200 bg-white shadow-sm transition-all opacity-70">
          <div className="w-5 h-5 rounded-full border-2 border-gray-300 bg-white flex-shrink-0"></div>
          <span className="text-[13px] sm:text-sm font-medium text-gray-600 leading-tight">Una hoja de cálculo avanzada</span>
        </div>
      </div>
    )
  },
  ...
  },
  {
    ...
    renderVisual: () => (
      <div className="w-full flex flex-col gap-6 sm:gap-8 justify-center h-full">
        <p className="text-base sm:text-lg lg:text-xl font-semibold text-slate-800 text-center px-2 sm:px-4 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full max-w-sm mx-auto">
          <button className="w-full flex-1 py-3.5 sm:py-4 rounded-xl text-sm sm:text-base font-bold text-brand-orange bg-brand-orange/10 border-2 border-brand-orange shadow-sm hover:bg-brand-orange/20 transition-colors">
            Verdadero
          </button>
          <button className="w-full flex-1 py-3.5 sm:py-4 rounded-xl text-sm sm:text-base font-bold text-gray-500 bg-white border-2 border-gray-200 shadow-sm hover:border-gray-300 hover:text-gray-700 transition-colors">
            Falso
          </button>
        </div>
      </div>
...
export default function OnboardingPage() {
  ...
  return (
    ...
    <main className="w-full bg-white">
      ...
      {/* 
        SOLUCIÓN UX: En celular usamos justify-start para que inicie arriba igual que Estudio (pt-8).
        En PC (lg), regresa a justify-center con min-h-[85vh] para mantener tu diseño centrado original. 
      */}
      <section className="flex flex-col justify-start lg:justify-center lg:min-h-[85vh]">
        <div className="max-w-7xl mx-auto px-6 pt-8 pb-12 md:pt-20 md:pb-24 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center w-full">
          ...
          >
            <div className="flex items-center gap-4 text-xs font-semibold tracking-widest text-gray-500 uppercase">
              <span className="w-8 h-[2px] bg-brand-orange shrink-0"></span>
              ONBOARDING INTERACTIVO · DEINSA GLOBAL
            </div>

            <h2 className="text-[2.25rem] leading-[1.15] sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-black tracking-tight">
          ...
          <div className="flex lg:hidden w-full pt-4 justify-center">
            <Link href="/ecosistema" className="w-full sm:w-auto px-8 py-4 bg-brand-orange text-white text-base font-bold rounded-xl shadow-lg hover:bg-orange-600 transition-colors flex items-center justify-center text-center">
              Ver Ecosistema Delphos
            </Link>
          </div>
      ...
      <section className="bg-slate-50 border-t border-b border-gray-100 py-12 sm:py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-black leading-tight tracking-tight mb-4 sm:mb-5">
            ...
            {ONBOARDING_STAGES.map((stage, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4 mb-4 sm:mt-5 sm:mb-6">
                    {isActive ? (
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-2 sm:mb-3">
                    {stage.title}
                  </h3>
      ...
      {/* SECCIÓN 3: Progreso e Insignias */}
      <section className="bg-[#0b0b0c] text-white py-14 sm:py-16 lg:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[42px] font-extrabold leading-[1.1] tracking-tight mb-4 sm:mb-5">
            ...
            <div className="mt-6 mb-8 flex items-start gap-3 bg-[#17171a] border border-[#232327] p-4 rounded-xl max-w-xl">
              ...
              <p className="text-[13px] sm:text-[13.5px] text-[#b8b5ae] leading-relaxed">
          ...
          >
            <div className="flex items-center gap-5 sm:gap-8">
              <div className="relative w-[84px] h-[84px] sm:w-[118px] sm:h-[118px] flex-shrink-0">
                <svg viewBox="0 0 120 120" className="w-full h-full -rotate-90">
                  ...
                  <motion.circle 
                    ...
                    whileInView={{ strokeDashoffset: 125.66 }} 
                    viewport={{ once: true, amount: 0.4 }}
                    transition={{ duration: 1.5, ease: 'easeOut', delay: 0.5 }}
                  />
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-xl sm:text-[26px] font-extrabold tracking-tight">60%</span>
                </div>
              </div>
              <div>
                <h3 className="text-base sm:text-[18px] font-semibold mb-1 tracking-tight">Colección de Insignias</h3>
                <p className="text-[13px] sm:text-sm text-[#b8b5ae]">3 de 5 insignias desbloqueadas</p>
              </div>
            </div>
              ...
              {PROGRESS_BARS.map((bar, i) => (
                <div key={i} className="flex flex-col">
                  <div className="flex justify-between items-end mb-2">
                    <span className="text-[12px] sm:text-[13.5px] font-medium text-white">{bar.label}</span>
                    <span className="text-[12px] sm:text-[13.5px] font-mono text-[#b8b5ae]">
                      {bar.pct === 100 ? 'Desbloqueada' : `${bar.pct}%`}
                    </span>
                  </div>
                  <div className="h-[6px] sm:h-[7px] w-full bg-[#232327] rounded-full overflow-hidden">
                    <motion.div 
      ...
      <section className="bg-white py-12 sm:py-16 lg:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 border-b border-gray-100 pb-5 mb-8 lg:mb-12">
            {STUDY_METHODS.map((method, idx) => {
              ...
              return (
                <button
                  ...
                  className={`flex-grow sm:flex-grow-0 flex items-center justify-center gap-2 px-4 py-3 sm:py-2.5 rounded-xl sm:rounded-full text-sm font-semibold transition-all duration-200 border ${
                    isActive 
                      ? 'bg-brand-orange border-brand-orange text-white shadow-md' 
                      : 'bg-white border-gray-200 text-gray-600 hover:border-gray-300 hover:text-slate-800'
                  }`}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center min-h-[320px]">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h3 className="text-[22px] sm:text-3xl font-bold text-slate-900 leading-tight">
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                transition={{ duration: 0.3 }}
                className="w-full h-full min-h-[260px] sm:min-h-[300px] bg-slate-50 border border-gray-100 rounded-3xl p-5 sm:p-8 flex items-center justify-center shadow-inner"
              >
