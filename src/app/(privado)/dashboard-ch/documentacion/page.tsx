...
export default function DocumentacionPage() {
  ...
  return (
    <div className="w-full flex-1 px-4 py-6 sm:py-8 sm:px-6 lg:px-10 xl:px-14 bg-[#f8f9fa] min-h-screen">
      ...
      <section className="rounded-3xl bg-white p-5 sm:p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-3 w-full xl:w-auto">
            <button 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-xl bg-white border border-gray-200 px-4 py-2.5 text-sm font-bold text-gray-600 shadow-sm transition-all hover:bg-gray-50 hover:text-brand-orange"
            >
            ...
            <button 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-xl bg-gray-900 px-4 py-2.5 text-sm font-bold text-white shadow-md transition-all hover:bg-gray-800 hover:shadow-lg"
            >
            ...
            <button 
              onClick={abrirCrear}
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-brand-orange to-[#f97316] px-5 py-2.5 text-sm font-bold text-white shadow-md transition-all hover:scale-105 hover:shadow-lg hover:shadow-brand-orange/20"
            >
              <svg className="mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                <div className="p-5 sm:p-6 md:p-8 pl-7 sm:pl-8 md:pl-10">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-5 sm:mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-lg sm:text-xl font-extrabold text-gray-900 leading-tight">{mod.titulo}</h3>
                        <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-gray-400 mt-1">Módulo de IA</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0 self-end sm:self-auto">
                      <button 
                        ...
                        className="inline-flex items-center justify-center rounded-lg bg-gray-50 p-2 sm:p-2.5 text-gray-500 transition-all hover:bg-brand-orange/10 hover:text-brand-orange focus:outline-none"
                        title="Editar"
                      >
                      ...
                      <button 
                        ...
                        className="inline-flex items-center justify-center rounded-lg bg-gray-50 p-2 sm:p-2.5 text-gray-500 transition-all hover:bg-red-50 hover:text-red-500 focus:outline-none"
                        title="Eliminar"
                      >
                        <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      ...
      {modalAbierto && (
        <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center bg-gray-900/60 p-0 sm:p-4 backdrop-blur-sm">
          <div className="w-full max-w-4xl overflow-hidden rounded-t-3xl sm:rounded-3xl bg-white shadow-2xl flex flex-col max-h-[90vh] sm:max-h-[85vh]">
            <div className="flex items-start justify-between border-b border-gray-100 bg-white p-5 sm:p-8 relative z-10">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] sm:text-sm text-gray-500 mt-1">Alimenta el cerebro de la IA con información estructurada.</p>
                </div>
              </div>
              <button
            ...
            <div className="p-5 sm:p-8 overflow-y-auto deinsa-scroll flex-1 bg-gray-50/50">
              <form id="form-doc" onSubmit={handleSubmit} className="flex flex-col gap-5 sm:gap-6 h-full">
                ...
                <div className="bg-white p-5 sm:p-6 rounded-2xl border border-gray-100 shadow-sm flex-1 flex flex-col">
                  ...
                  <textarea
                    className="w-full h-full min-h-[30vh] sm:min-h-[250px] rounded-xl border border-gray-200 bg-gray-50 py-4 px-4 text-sm font-medium text-gray-700 leading-relaxed focus:bg-white focus:border-brand-orange focus:ring-2 focus:ring-brand-orange/20 transition-all outline-none resize-none deinsa-scroll"
            ...
            <div className="p-5 sm:p-6 border-t border-gray-100 flex flex-col-reverse sm:flex-row justify-end gap-3 bg-white relative z-10 pb-8 sm:pb-6">
              <button 
                type="button" 
                onClick={() => setModalAbierto(false)} 
