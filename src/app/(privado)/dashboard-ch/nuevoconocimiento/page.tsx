      ...
      <section className="rounded-3xl bg-white p-6 sm:p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100">
        ...
        <div className="mb-8 relative max-w-md">
          ...
          <input
            ...
            placeholder="Buscar en el registro de IA (Ctrl+F)..."
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mt-1">Pregunta sin respuesta oficial</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center shrink-0">
                      <button 
                        ...
                        className="inline-flex items-center justify-center rounded-xl bg-gray-50 p-2.5 text-gray-400 transition-all hover:bg-red-50 hover:text-red-500 focus:outline-none"
